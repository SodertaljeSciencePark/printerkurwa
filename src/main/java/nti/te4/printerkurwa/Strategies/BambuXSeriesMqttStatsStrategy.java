...
@Service
public class BambuXSeriesMqttStatsStrategy implements StatsStrategy {
        ...
        try {
            ...
            client.connectWith()
                    ...
                    .whenComplete((connAck, throwable) -> {
                        if (throwable != null) {
                            System.err.println("--- KUNDE INTE STARTA MQTT FÖR BAMBU X-SERIES ---");
                        ...
                        client.subscribeWith()
                                ...
                                .whenComplete((subAck, subThrowable) -> {
                                    if (subThrowable != null) {
                                        ...
                                        System.out.println("Linked! Listening on X-Series stats from: " + printer.getIp() + " on topic: " + topic);
                                    }
                                });
                    });
    ...
    private void handleMessage(Mqtt3Publish publish, Printer printer, Map<UUID, PrinterStats> statsMap) {
        try {
            ...
            System.err.println("Error occurred while handling MQTT message for X-Series printer: " + printer.getName());
        }
    }
}
